...
export function FinancialResources({ headers, id, plan }) {
  // ===== CONTEXT =====
  ...
  return (
    <>
      {plan === "gold" ? (
                            ...
                            <>
                              ...
                              >
                                ...
                                <div>
                                  ...
                                  >
                                    • Confirme se as{" "}
                                    <strong>mensalidades dos alunos</strong>{" "}
                                    estão atualizadas
                                    <br />• Verifique se há{" "}
                            ...
                            .map((student, index) => (
                              ...
                              >
                                ...
                                <div
                                  ...
                                  title={
                                    student.onHold ? "Matrícula trancada" : ""
                                  }
                                >
                                  <div
                                    style={{
                      ...
                      <label className="linguee-checkbox-item">
                        <div className="linguee-toggle">
                          <input
                            ...
                            onChange={(e) =>
                              setNewItemPaidFor(e.target.checked)
                            }
                          />
                          <div className="linguee-toggle-slider"></div>
                        </div>
        ...
        <span>
          Faça upgrade para o plano Gold para acessar os Recursos Financeiros.
        </span>
      )}
    </>
  );
