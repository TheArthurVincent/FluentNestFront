...
type ListStudentsClassesProps = HeadersProps & {
  change?: boolean;
...
export function ListStudentsClasses({
  actualHeaders,
  isDesktop,
}: ListStudentsClassesProps) {
  ...
  return (
    ...
    >
      ...
      >
        <input
          type="text"
          placeholder="🔍 Qual é o aluno cujas aulas você gostaria de ver?"
          value={search}
...
export default ListStudentsClasses;
