    ...
    >
      {isDesktop && (
        ...
        >
          ...
          >
            <span style={newArvinTitleStyle}>Lições</span>
          </section>
        </div>
      )}
      <div
                  ...
                  >
                    ...
                    <select
                      ...
                      style={{
                        ...
                        color: "#64748b",
                        padding:
                          window.innerWidth <= 768 ? "10px 12px" : "6px 8px",
                          ...
                          style={{
                            ...
                            padding:
                              window.innerWidth <= 768
                                ...
                                : "1rem 0.5rem",
                            maxWidth:
                              window.innerWidth <= 768 ? "100%" : "800px",
                          }}
                        >
                      ...
                      >
                        <h2
                          style={{
                            margin: 0,
                            fontSize:
                              window.innerWidth <= 768 ? "18px" : "16px",
                            fontWeight: "500",
                            color: "#495057",
                          }}
                        >
                        ...
                        <button
                          ...
                          style={{
                            ...
                            border: "none",
                            fontSize:
                              window.innerWidth <= 768 ? "28px" : "24px",
                            cursor: "pointer",
                            color: "#6b7280",
                            padding: "0",
                        ...
                        >
                          <button
                            ...
                            style={{
                              ...
                              borderRadius: 6,
                              minHeight:
                                window.innerWidth <= 768 ? "48px" : "auto",
                              backgroundColor:
                                submissionMode === "file"
                                  ? "#e9ecef"
                                  : "#f8f9fa",
                        ...
                        >
                          ...
                          <input
                            ...
                            style={{
                              width: "100%",
                              padding:
                                window.innerWidth <= 768 ? "16px" : "12px",
                              ...
                              minHeight:
                                window.innerWidth <= 768 ? "60px" : "auto",
                            }}
                            onFocus={(e) => {
